...
const TESTS := [
	...
	"res://sim/tests/test_settlement_layout.gd",
	"res://sim/tests/test_e17a_fixture.gd",
	"res://sim/tests/test_world_knowledge.gd",
	...
	"res://sim/tests/test_dungeon_world_journey.gd",
