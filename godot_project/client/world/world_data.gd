	...
	return {
		...
		"entities": [
			...
			{"kind": "creature", "id": "sprite_d1", "enemy_id": "steam_sprite", "pos": [12, 9], "requires_spell": SPELL_RED,
				"intro": "A Steam Sprite, born where the fire met the pond. Two slots, Fire or Water — and it reads you faster than the imps did."},
			...
			{"kind": "creature", "id": "golem_d1", "enemy_id": "cinder_golem", "pos": [8, 2], "requires_spell": SPELL_RED,
				"intro": "A Cinder Golem blocks the old road. It throws Stone and Fire — but its Ward is Water and Vine, the things that put a fire out.\n\nWhat a thing attacks with is not what protects it.",
				"drops": "stone_shard"},
	...
	return {
		...
		"entities": [
			...
			{"kind": "pickup", "id": "halvard_staff", "pos": [10, 8], "sprite": "staff", "requires_flag": "halvard_dead",
				...
				"text": "Halvard's staff. It is cold, and it hums, and it does not seem to mind whose hand it is in.\n\nYou have learned WATER magic.\nYour weave can hold ONE spell."},
