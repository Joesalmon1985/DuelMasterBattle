...
func build_g04_battle_pages() -> void:
	...
	pages.insert(2, {
		...
		"title": "Spells",
		"kind": "actions",
		"body": "Select a spell then a world unit. The book collapses to a targeting card while aiming.",
		"actions": [
			...
			{"id": "spell_frequency", "label": "Atk Spd", "needs_target": true,
				"target_label": "Atk Spd", "target_guidance": "Tap a unit to buff attack speed."},
